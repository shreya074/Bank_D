...
<head>
    ...
    <title>Dhaachuko Bank - Close Account</title>
    <!-- Bootstrap CSS -->
...
<body>
   ...
   <div class="container">
        <div class="content">
            <h3>Close Account</h3>
            <form action="CustomerCloseAccountServlet" method="POST">
                <p>Are you sure you want to close your account? This action cannot be undone.</p>
                <button type="submit" class="btn btn-custom">Close Account</button>
            </form>
        </div>
    </div>
