...
<head>
    ...
    <title>Dhaachuko Bank - Deposit</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <form id="depositForm" action="CustomerDepositServlet" method="post">
    ...
    <script>
        ...
        if (urlParams.get('error') === 'DepositFailed') {
            $('#failureModal').modal('show');
        } else if (urlParams.get('success') === 'DepositSuccessful') {
