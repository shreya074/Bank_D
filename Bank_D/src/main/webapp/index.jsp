...
<div class="container">
        ...
        <div class="col-lg-6 col-md-12">
            <h1 class="mb-4">Welcome to Dhaachuko Bank</h1>
            <p class="mb-4">Your trusted partner in financial services.</p>
            <a href="admin_login.jsp" class="btn btn-custom">Admin</a>
            <a href="customer_login.jsp" class="btn btn-custom">Customer</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box">
                <h2>Dhaachuko Bank</h2>
                <p>Dhaachuko Bank is dedicated to providing secure and efficient financial services to our customers.</p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="box">
