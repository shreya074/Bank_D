...
<%@ page import="com.dhaachuko.model.Transaction" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Dhaachuko Bank - Transaction History</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <!-- Link to download last 10 transactions as PDF -->
            <a class="btn btn-primary btn-custom" href="CustomerTransactionsServlet?action=pdf">Download Last 10 Transactions as PDF</a>
